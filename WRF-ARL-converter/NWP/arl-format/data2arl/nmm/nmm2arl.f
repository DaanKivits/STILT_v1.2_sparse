...
!     unit 40 NMMTIME  - time indicator file
!
! ATTRIBUTES:
!   LANGUAGE: FORTRAN 90
!   MACHINE:  IBM RS6000
...
!-------------------------------------------------------------------------------
  ...
  SUBROUTINE MAKNDX (N2DV,N3DV,VCHAR0,VCHAR1,SIGL,NXP,NYP,NZP,   &
                     CLAT2,CLON2,GRIDKM,KVC,MODEL,OFFSET)
  IMPLICIT NONE
...
!      standard output name for packed data
       INQUIRE(FILE='DATA.NMM',EXIST=FTEST)
       LREC=NXY+50
       OPEN(20,FILE='DATA.NMM',RECL=LREC,ACCESS='DIRECT',FORM='UNFORMATTED')
