...
!
! PROGRAM:     AFWA2ARL         DECODE AFWA GRIB ETA MODEL FOR HYSPLIT
...
!     check for command line arguments
      narg=IARGC()
      if(narg.eq.0)then
         write(*,*)'Usage: afwa2arl [file_1] [file_2] [...]'
         write(*,*)'Convert pressure eta grib file to arl format'
         stop
      end if
...
!     number of levels, variables, and array limits
      PARAMETER (NLVL=24, MVAR=6, MAXX=185, MAXY=129, MAXB=90000)
...
!     set requested sigma levels for input and output
      DATA SIGL/ 0,1000,975,950,925,900,875,850,800,750,700,650,600, &
